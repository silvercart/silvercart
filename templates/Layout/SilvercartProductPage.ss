<div class="row">
    <div class="span9" itemscope itemtype="http://schema.org/Product">
        ...
        <div id="sc-product-backlink" class="clearfix">
            ...
            <% end_if %>
            <a class="btn btn-small pull-left" href="javascript:window.print()" title="<% _t('Silvercart.PRINT') %>">
                <i class="icon-print"></i>
            </a>
            <a class="btn btn-small pull-left" href="{$getProduct.ProductQuestionLink}" title="<% _t('SilvercartProduct.PRODUCT_QUESTION_LABEL') %>">
