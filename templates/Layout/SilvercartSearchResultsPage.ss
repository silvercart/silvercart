    ...
    <div id="col1">
        ...
        <div id="col2">
            <div id="col2_content" class="clearfix">
                <div id="col2_contentcontainer" style="position: absolute; top: 0px; ">
                    $SubNavigation
                    $InsertWidgetArea(SidebarLeft)
                </div>
            </div>
        </div>
        <div id="col3">
            <div id="col3_content" class="clearfix">
                <div id="col3_contentcontainer" style="position: absolute; top: 0px; ">
                    $InsertWidgetArea(SidebarRight)
                </div>
            </div>
        </div>
</div>
