<table class="table silvercart-order-table" cellspacing="0" cellpadding="0" border="0">
    ...
    <tbody>
        ...
        <tr class="new-block">
            ...
            <td class="mobile-hide-sm">&nbsp;</td>
            <td class="mobile-hide-sm">&nbsp;</td>
            <td class="desc-col"><strong><% _t('SilvercartPage.VALUE_OF_GOODS') %></strong></td>
        ...
        <% if HasChargePositionsForProduct %>
            ...
            <% loop getTaxableAmountGrossWithoutFees(true,false) %>
                <tr class="new-block">
                    ...
                    <td class="mobile-hide-sm">&nbsp;</td>
                    <td class="mobile-hide-sm">&nbsp;</td>
                    <td class="text-right desc-col"><strong><% _t('SilvercartPage.SUBTOTAL') %></strong></td>
            ...
            <% loop getTaxRatesWithoutFees(true,false) %>
                <tr class="new-block">
                    <td class="mobile-hide-sm">&nbsp;</td>
                    <td class="mobile-hide-sm">&nbsp;</td>
                    <td class="text-right desc-col" colspan="3"><% _t('SilvercartPage.INCLUDED_VAT','included VAT') %> ({$Rate}%)</td>
                    <td class="text-right price-col">{$Amount.Nice}</td>
                </tr>
            <% end_loop %>
        <% end_if %>
        ...
        <% if SilvercartOrderChargePositionsTotal %>
            ...
            <tr class="{$EvenOdd} auto">
                ...
                <% end_if %>
                <td class="text-right price-col"><strong>{$PriceTotal.Nice}</strong></td>
            </tr>
            <% end_loop %>
        <% end_if %>
