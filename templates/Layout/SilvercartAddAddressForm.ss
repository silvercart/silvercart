<form class="form" {$FormAttributes} >
    ...
    <h4><%t SilvercartAddressHolder.ADD %></h4>
...
<% end_loop %>
    <a class="btn btn-small js-link" id="silvercart-add-address-form-cancel-id" href="{$CancelLink}" title="<%t SilvercartPage.CANCEL %>"><%t SilvercartPage.CANCEL %></a>
</form>
