        ...
        <% loop registeredModules %>
            ...
            <% if TaxableShoppingCartPositions %>
                <tr>
                    ...
                    <td class="right price" id="Sum"><strong><% with CurrentMember.SilvercartShoppingCart %>$TaxableAmountGrossWithoutFeesAndChargesAndModules.Nice<% end_with %></strong></td>
    ...
    <% end_if %>
        ...
        <% else %>
            ...
            <tr>
                <td colspan="3">&nbsp;</td>
                <td colspan="3" class="right"><strong><% _t('SilvercartPage.TOTAL','total') %></strong></td>
                <td class="right price total"><strong>$AmountTotal.Nice<% with ShippingMethod.ShippingFee %><% if PostPricing %>*<% end_if %><% end_with %></strong></td>
