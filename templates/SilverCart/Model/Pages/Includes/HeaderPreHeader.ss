    ...
    <div class="container">
        <ul class="pull-right inline">
            <% if $CurrentRegisteredCustomer %>
                ...
                <li class="divider-vertical"></li>
                <li><a class="highlight" href="{$logoutURL}"><%t SilverCart\Model\Pages\Page.LOGOUT 'Logout' %></a></li>
                <li class="divider-vertical"></li>
            <% else %>
        ...
        <% if $CurrentRegisteredCustomer %>
            <p><%t SilverCart\Model\Pages\Page.HELLO 'Hello' %> $CurrentRegisteredCustomer.FirstName, <a href="$PageByIdentifierCode(SilvercartMyAccountHolder).Link"><%t SilverCart\Model\Pages\Page.MYACCOUNT 'my account' %></a>, <a href="{$logoutURL}"> <%t SilverCart\Model\Pages\Page.LOGOUT 'Logout' %></a></p>
        <% else %>
