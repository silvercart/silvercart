        ...
        <li class="span6 silvercart-product-group-page-tile-item {$EvenOdd} clearfix <% if MultipleOf(2) %>last-in-row<% end_if %>" id="product{$ID}">
            ...
            <div class="sc-product-shortinfo">
                <div class="sc-product-title">
                    <h2>
                        <a href="$Link" class="highlight" title="<%t SilverCart\Model\Pages\Page.SHOW_DETAILS_FOR 'Show details for {title}' title=$Title %>">$Title.HTML</a> {$Availability}
                    </h2>
                </div>
                ...
                <div class="thumbPrice">
                    ...
                    <div id="toogle{$ID}" class="collapse">
                        ...
                        <p>
                            <small><%t SilverCart\Model\Product\Product.PRODUCTNUMBER_SHORT 'Item no.' %>: $ProductNumberShop</small>
                        </p> 
