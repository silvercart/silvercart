...
<div style="text-align: center; border: 1px solid #ccc; background-color: #fafafa;">
    <div style="display: inline-block; text-align: left; vertical-align: top;">
        <div style="padding: 12px 16px;">
            ...
            <% if $TrackingCode %>
                <tr>
                    <td style="padding: 0.2em 0.5em 0.2em 0;">{$fieldLabel('TrackingCode')}</td>
                    <td style="padding: 0.2em 0 0.2em 0.5em;"><strong>{$TrackingCode}</strong></td>
                </tr>
                <% if $TrackingLink %>
                <tr>
                    <td style="padding: 0.2em 0.5em 0.2em 0;">&nbsp;</td>
                    <td style="padding: 0.2em 0 0.2em 0.5em;"><a href="{$TrackingLink}" target="blank" title="{$fieldLabel('TrackingLinkLabel')}">{$fieldLabel('TrackingLinkLabel')}</a></td>
                </tr>
                <% end_if %>
            <% end_if %>
            </table>
