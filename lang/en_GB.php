...
$lang['en_GB']['SilvercartTestData']['PRODUCTPAYMENTPREPAYMENT_SHORTDESC']          = 'Flexible payment system for all paymentsystems which don' . "'" . 't need automated logic.';
$lang['en_GB']['SilvercartTestData']['PRODUCTPAYMENTPREPAYMENT_LONGDESC']           = 'Flexible payment system for all paymentsystems which don' . "'" . 't need automated logic. This module provides beside prepayment also payment via invoice.';
