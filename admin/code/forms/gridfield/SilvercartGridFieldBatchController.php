 ...
 */
class SilvercartGridFieldBatchController implements GridField_HTMLProvider, GridField_ActionProvider, GridField_URLHandler, GridField_ColumnProvider {
    ...
    public function getDropdownName() {
        return 'SilvercartGridFieldBatchControllerDropdown_' . $this->getTargetClassName();
    }
    ...
    public function getCheckboxName($withBrackets = true) {
        ...
        return 'SilvercartGridFieldBatchControllerCheckbox_' . $this->getTargetClassName() . $brackets;
    }
    ...
    public function getHTMLFragments($gridField) {
        ...
        $button = new GridField_FormAction(
                $gridField, 'execute_batch_action', _t('Silvercart.EXECUTE', 'Execute'), 'handleBatchAction', null
        );
        $button->setAttribute('data-icon', 'navigation');
        $button->addExtraClass('gridfield-button-batch');
        
        return array(
            $this->targetFragment => '<div class="grid-batch-action-button"><div class="field dropdown plain">' . $dropdown->Field() . '</div><div class="grid-batch-action-callback-target"></div>' . $button->Field() . '</div>',
        );
    }
    ...
    public function handleAction(GridField $gridField, $actionName, $arguments, $data) {
        if ($actionName == 'handlebatchaction') {
            $targetBatchAction = $data[$this->getDropdownName()];
    ...
    public function getColumnMetadata($gridField, $columnName) {
        $title = sprintf(
                ...
                _t('Silvercart.MARK_ALL'),
                _t('Silvercart.UNMARK_ALL')
        );
        return array(
            'title' => $title,
        );
