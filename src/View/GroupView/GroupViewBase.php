...
class GroupViewBase extends ViewableData {
    ...
    public function Image() {
        ...
        if (!$this->Image) {
            ...
            } elseif (is_file(Director::baseFolder() . '/resources/silvercart/silvercart/client/img/icons/20x20_group_view_' . $this->preferences['code'] . '_' . $highlightStatus . '.png')) {
                $this->preferences['image'] = Director::absoluteBaseURL() . 'resources/silvercart/silvercart/client/img/icons/20x20_group_view_' . $this->preferences['code'] . '_' . $highlightStatus . '.png';
            } else {
