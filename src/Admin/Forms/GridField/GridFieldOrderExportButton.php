 ...
 */
class GridFieldOrderExportButton implements GridField_HTMLProvider, GridField_ActionProvider, GridField_URLHandler
{
     ...
     * 
     * @return GridFieldOrderExportButton
     */
    public function __construct(string $exportMode = self::EXPORT_MODE_PREVIOUS_MONTH, string $targetFragment = "buttons-before-left")
    {
        ...
        $this->setExportColumns(Order::singleton()->exportColumns());
    }
     ...
     * @return $this
     */
    public function setExportColumns(array $cols) : GridFieldOrderExportButton
    {
     ...
     * @return $this
     */
    public function setCsvSeparator(string $separator) : GridFieldOrderExportButton
    {
     ...
     * @return $this
     */
    public function setCsvEnclosure(string $enclosure) : GridFieldOrderExportButton
    {
     ...
     * @return $this
     */
    public function setCsvHasHeader(bool $bool) : GridFieldOrderExportButton
    {
     ...
     * 
     * @return \SilverCart\Admin\Forms\GridField\GridFieldOrderExportButton
     */
    public function setExportMode(string $exportMode) : GridFieldOrderExportButton
    {
