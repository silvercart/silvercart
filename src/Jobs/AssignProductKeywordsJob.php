 ...
 */
class AssignProductKeywordsJob extends AbstractQueuedJob
{
    use Configurable;
    use Injectable;
    /**
    ...
    {
        return _t(__CLASS__ . '.Title', 'Assign Product Keywords');
    }
    ...
    public function process() : void
    {
        ...
        $this->currentStep = 1;
        $this->queueNextJob();
        $this->addMessage("Starting assigning product keywords.");
