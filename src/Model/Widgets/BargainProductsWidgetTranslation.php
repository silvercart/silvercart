...
/**
 * Translation object of BargainProductsWidget.
 *
 * @package SilverCart
 ...
 */
class BargainProductsWidgetTranslation extends DataObject {
    ...
    private static $has_one = array(
        'BargainProductsWidget' => BargainProductsWidget::class,
    );
     ...
     * @var string
     */
    private static $table_name = 'SilvercartBargainProductsWidgetTranslation';
    ...
    public function fieldLabels($includerelations = true) {
        $fieldLabels = array_merge(
                ...
                array(
                    ...
                    'BargainProductsWidget' => BargainProductsWidget::singleton()->singular_name(),
                )
        );
