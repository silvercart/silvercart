 ...
 */
class ImageSliderWidgetTranslation extends DataObject {
    ...
    private static $has_one = array(
        'ImageSliderWidget' => ImageSliderWidget::class,
    );
     ...
     * @var string
     */
    private static $table_name = 'SilvercartImageSliderWidgetTranslation';
