...
class SilvercartContactFormPage extends SilvercartMetaNavigationHolder {
    ...
    public function getCMSFields() {
        ...
        $fields->findOrMakeTab('Root.Content.FormFields', $this->fieldLabel('FormFieldsTab'));
        $fields->addFieldToTab('Root.Content.FormFields', new CheckboxField('EnableStreet', $this->fieldLabel('EnableStreet')));
        $fields->addFieldToTab('Root.Content.FormFields', new CheckboxField('StreetIsRequired', $this->fieldLabel('StreetIsRequired')));
        $fields->addFieldToTab('Root.Content.FormFields', new CheckboxField('EnableCity', $this->fieldLabel('EnableCity')));
        $fields->addFieldToTab('Root.Content.FormFields', new CheckboxField('CityIsRequired', $this->fieldLabel('CityIsRequired')));
        $fields->addFieldToTab('Root.Content.FormFields', new CheckboxField('EnableCountry', $this->fieldLabel('EnableCountry')));
        $fields->addFieldToTab('Root.Content.FormFields', new CheckboxField('CountryIsRequired', $this->fieldLabel('CountryIsRequired')));
        $fields->addFieldToTab('Root.Content.FormFields', new CheckboxField('EnablePhoneNumber', $this->fieldLabel('EnablePhoneNumber')));
        $fields->addFieldToTab('Root.Content.FormFields', new CheckboxField('PhoneNumberIsRequired', $this->fieldLabel('PhoneNumberIsRequired')));
