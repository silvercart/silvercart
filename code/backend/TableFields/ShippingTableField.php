...
class ShippingTableField extends ComplexTableField {
    ...
    public function FieldHolder() {
        ...
        Requirements::javascript(PIXELTRICKS_CHECKOUT_BASE_PATH_REL . 'js/ShippingTableField.js');
    ...
    public function Items() {
        ...
        foreach ($this->sourceItems as $pageIndex => $item) {
            $output->push(Object::create('ShippingTableField_Item', $item, $this, $pageStart + $pageIndex));
        }
        return $output;
    }
 ...
 * @license none
 */
class ShippingTableField_Item extends ComplexTableField_Item {
