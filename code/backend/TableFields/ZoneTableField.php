...
class ZoneTableField extends ComplexTableField {
    ...
    public function FieldHolder() {
        ...
        Requirements::javascript(PIXELTRICKS_CHECKOUT_BASE_PATH_REL . 'js/ZoneTableField.js');
    ...
    public function Items() {
        ...
        foreach ($this->sourceItems as $pageIndex => $item) {
            $output->push(Object::create('ZoneTableField_Item', $item, $this, $pageStart + $pageIndex));
        }
        return $output;
    }
...
/**
 * Single row of a {@link ZoneTableField}
 *
 * @package fashionbids
 * @author Sascha Koehler <skoehler@pixeltricks.de>
 * @copyright 2010 pixeltricks GmbH
 ...
 * @license none
 */
class ZoneTableField_Item extends ComplexTableField_Item {
