 ...
 */
class SilvercartProductConditionAdmin extends ModelAdmin {
     ...
     * @var string
     */
    public static $menu_title = 'Silvercart product condition';
    ...
    public function __construct() {
        self::$menu_title = _t('SilvercartProductCondition.PLURALNAME');
